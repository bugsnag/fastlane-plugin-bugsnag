...
* Bump bugsnag-cli to v3.10.6 by updating the submodule reference to include latest CLI security fixes. [#7](https://github.com/bugsnag/fastlane-plugin-bugsnag/pull/7)

## 3.1.2 (25-08-2026)

### Enhancements

* Bump bugsnag-cli to v3.10.5 by updating the submodule reference to include latest CLI fixes and improvements. [#6](https://github.com/bugsnag/fastlane-plugin-bugsnag/pull/6)
...
* Migrate the Fastlane plugin to use the Bugsnag CLI for creating builds [#89](https://github.com/bugsnag/bugsnag-dsym-upload/pull/89)
* Migrate the Fastlane plugin to use the Bugsnag CLI for sending dSYMs [#88](https://github.com/bugsnag/bugsnag-dsym-upload/pull/88)
